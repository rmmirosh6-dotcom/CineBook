  ...
  Future<void> seedDatabase() async {
    final movies = [
      Movie(
        ...
        synopsis: 'When a former special ops agent discovers a deadly conspiracy reaching the highest levels of government, he must go off the grid — and off the rules — to stop a catastrophic attack.',
        isNowShowing: true,
      ),
      Movie(
        id: '2',
        ...
        synopsis: 'A brilliant detective haunted by a cold case from his past is forced to confront the truth when the only surviving witness resurfaces — 20 years later.',
        isNowShowing: true,
      ),
      Movie(
        id: '3',
        ...
        duration: '1h 55min',
        rating: 7.9,
        posterUrl: 'https://image.tmdb.org/t/p/w500/5FMm8MQ2u43JqPSMdoJORIGASbT.jpg',
        synopsis: 'Newlywed couple Ted and Tami-Lynn want to have a baby, but in order to qualify to be a parent, Ted will have to prove he is a person in a court of law.',
        isNowShowing: true,
      ),
      Movie(
        id: '4',
        ...
        synopsis: 'A new crew of astronauts is sent through a wormhole beyond our solar system in search of a second chance for humanity — and face a danger no one predicted.',
        isNowShowing: false,
      ),
    ];
